...
_ACTIONS_SCHEMA = {
    ...
    "items": {
        ...
        "properties": {
            ...
            "payload": {
                "type": "object",
                "description": "Action parameters. For BUILD_STRUCTURE: {sector_id, structure_type}. For SCAN_SECTOR: {sector_id}. For ATTACK_STRUCTURE: {target_structure_id}. For SET_POLICY: {target_player_id, stance}. For TRANSFER_RESOURCE: {target_player_id, resource_type, amount}. For REMOVE_STRUCTURE: {structure_id}.",
                "properties": {
                    "sector_id": {"type": "string"},
                    "structure_type": {"type": "string"},
                    "target_structure_id": {"type": "string"},
